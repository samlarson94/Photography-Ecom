...
const Cart = () => {
  ...
  return (
    <div className="cart-wrapper" ref={cartRef}>
      ...
      {/* Render Cart Items */}
      {/* If no items, add icon, message, and button to continue shopping */}
      {cartItems.length < 1 && (
    ...
    {/* If there are items, map over items and render 1st image, desc,  */}
      ...
      {/* Check if cart items is larger than 1, then render subtotal div */}
      {cartItems.length >= 1 && (
